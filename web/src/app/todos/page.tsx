...
export default async function TodosPage() {
  ...
  const key = resolveNextPublicSupabaseKey();
  if (!url || !key) {
    return (
      <div className="p-6">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1">NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY</code> or{" "}
          <code className="rounded bg-muted px-1">NEXT_PUBLIC_SUPABASE_ANON_KEY</code> (e.g. in{" "}
